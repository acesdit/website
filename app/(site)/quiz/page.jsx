...
const Option = ({ option, selectedOption, handleOptionSelect }) => {
  return (
    <li
      className={
        'box-border border-2 border-amber-950 p-4 rounded-2xl bg-amber-100 hover:cursor-pointer'
      }>
      <label>
        <input
          type='radio'
...
const Question = ({
  ...
  return (
    <div className={''}>
      ...
      <ul
        className={'flex flex-col gap-4 md:grid md:grid-cols-2 md:grid-rows-2'}>
  ...
  return (
    <div className={'h-fit'}>
      <div className='hero-container nav-target'>
        <main className='hero-bg'>
          <div className='container mx-auto p-4 md:px-6'>
            <div className='flex items-center pt-8 md:pt-10 text-white'></div>
          </div>
        </main>
      </div>
      <section className={`p-2 h-full`}>
        <div
          className={
            'p-2 border-2 border-solid border-amber-950 overflow-hidden rounded-2xl h-full box-border bg-amber-100'
          }>
          {currentQuestionIndex === -1 ? (
            <div className={'flex flex-col gap-4 py-10'}>
              ...
              <p className={'text-xl font-medium tracking-tight'}>
                Time for Each Question: {quizData.timeForEachQuestionInSeconds}{' '}
                Secs
              </p>
              <button
                onClick={handleNextQuestion}
                className={
                  'box-border border-2 py-4 rounded-2xl border-amber-950 bg-amber-100 md:w-fit md:px-10'
                }>
                Begin Quiz
              </button>
            </div>
            ...
            <div>
              <div
                className={'relative h-2 bg-gray-200 mb-12 mt-4 rounded-full'}>
                <div
                  className={
                    'absolute top-0 left-0 h-full bg-red-950 rounded-full'
                  }
              ...
              <div className={'flex h-fit gap-4'}>
                {currentQuestionIndex > 0 && (
                  <button
                    className={
                      'box-border w-full border-2 py-4 rounded-2xl border-amber-950 bg-amber-100 my-4 right-0'
                    }
            ...
            <div
              className={
                'm-20 flex items-center justify-center text-center align-middle'
              }>
